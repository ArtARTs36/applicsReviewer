 ...
 */
class WorkServiceMigrateMaker extends AbstractMigration
{
    const WORK_ID = 1;
...
17. Представление интересов в органах и организациях.';
        ...
        foreach ($array as $item) {
            ...
            $this->addSql("INSERT INTO `works_services` (`works_id`, `name`, `content`, `icon`, `created`) VALUES ('". self::WORK_ID ."', '{$item}', '{$item}', '1', '2019-11-04 00:00:00');");
        }
    }
    ...
    {
        $this->addSql('DELETE FROM `works_services` WHERE `works_services`.`work_id` = '. self::WORK_ID .';');
    }
}
